...
import de.fraunhofer.iml.opentcs.example.commadapter.vehicle.TshProcessModel;
...
/**
 * A serializable representation of a {@link TshProcessModel}.
 ...
 */
public class TshProcessModelTO
   ...
   * @return This
   */
  public TshProcessModelTO setVehicleRef(TCSObjectReference<Vehicle> vehicleRef) {
   ...
   * @return This
   */
  public TshProcessModelTO setCurrentState(
   ...
   * @return This
   */
  public TshProcessModelTO setPreviousState(
   ...
   * @return This
   */
  public TshProcessModelTO setLastOrderSent(
   ...
   * @return This
   */
  public TshProcessModelTO setVehicleHost(String vehicleHost) {
   ...
   * @return This
   */
  public TshProcessModelTO setVehiclePort(int vehiclePort) {
   ...
   * @return This
   */
  public TshProcessModelTO setPeriodicStateRequestEnabled(boolean periodicStateRequestEnabled) {
   ...
   * @return This
   */
  public TshProcessModelTO setStateRequestInterval(int stateRequestInterval) {
   ...
   * @return This
   */
  public TshProcessModelTO setVehicleIdleTimeout(int vehicleIdleTimeout) {
   ...
   * @return This
   */
  public TshProcessModelTO setVehicleIdle(boolean vehicleIdle) {
   ...
   * @return This
   */
  public TshProcessModelTO setDisconnectingOnVehicleIdle(boolean disconnectingOnVehicleIdle) {
   ...
   * @return This
   */
  public TshProcessModelTO setReconnectingOnConnectionLoss(boolean reconnectingOnConnectionLoss) {
   ...
   * @return This
   */
  public TshProcessModelTO setReconnectDelay(int reconnectDelay) {
   ...
   * @return This
   */
  public TshProcessModelTO setLoggingEnabled(boolean loggingEnabled) {
