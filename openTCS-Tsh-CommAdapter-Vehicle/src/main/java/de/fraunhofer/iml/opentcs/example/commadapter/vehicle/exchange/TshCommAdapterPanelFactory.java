 ...
 */
public class TshCommAdapterPanelFactory
    implements VehicleCommAdapterPanelFactory {

  /**
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(TshCommAdapterPanelFactory.class);
  /**
   * The service portal.
   */
   ...
   */
  @Inject
  public TshCommAdapterPanelFactory(KernelServicePortal servicePortal,
  ...
  public List<VehicleCommAdapterPanel> getPanelsFor(
    ...
    panels.add(componentsFactory.createControlPanel((TshProcessModelTO) processModel,
                                                    servicePortal.getVehicleService()));
    panels.add(componentsFactory.createStatusPanel((TshProcessModelTO) processModel,
                                                   servicePortal.getVehicleService()));
    return panels;
  }
  ...
  private boolean providesPanelsFor(VehicleCommAdapterDescription description,
    ...
    return (description instanceof TshCommAdapterDescription)
        && (processModel instanceof TshProcessModelTO);
  }
}
